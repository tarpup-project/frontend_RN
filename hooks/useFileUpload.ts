...
// // Simple conversion without the Android-specific handling
// const convertFileToBase64 = async (uri: string): Promise<string> => {
//   try {
//     const base64 = await FileSystem.readAsStringAsync(uri, {
//       encoding: 'base64' as any, // Type assertion to bypass TypeScript issue
//     });
...
//       const fileData = await convertFileToBase64(file.uri);

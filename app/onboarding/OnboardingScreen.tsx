...
//   console.log("🔵 OnboardingScreen rendered with:", { title, icon: typeof icon, iconDark: typeof iconDark });
//   const { isDark } = useTheme();
//   console.log("🔵 Theme loaded, isDark:", isDark);
...
//     console.log("🔵 iconToRender type:", typeof iconToRender, "value:", iconToRender);

//     if (typeof iconToRender === "string") {
//       console.log("🔵 Rendering string icon:", iconToRender);
...
//       }
//     }
//     console.log("🔵 Falling back to Image component");
//     return (
//       <Image

...
const GroupChat = () => {
  ...
  return (
    <GroupSocketProvider groupId={groupId as string}>
      <GroupChatContent groupId={groupId as string} />
    </GroupSocketProvider>
  );
};
...
const GroupChatContent = ({ groupId }: { groupId: string }) => {
  ...
  const { messages, isLoading, error, sendMessage, markAsRead } = useGroupMessages({ groupId });

  ...
  return (
    ...
    >
      <View style={styles.cardHeader}>
        ...
        <View
          style={[styles.skeletonButton, { backgroundColor: skeletonColor }]}
        />
      </View>
      <View
        style={[styles.skeletonTitle, { backgroundColor: skeletonColor }]}
      />
      <View
        style={[styles.skeletonSubtitle, { backgroundColor: skeletonColor }]}
      />
    </View>
  );
};
          ...
          {!isLoadingPrompts &&
            prompts.map((prompt) => (
              ...
              >
                ...
                <Text
                  style={[styles.promptTitle, dynamicStyles.promptTitle]}
                >
                  {prompt.description}
                </Text>
                <Text style={[styles.authorText, dynamicStyles.subtitle]}>

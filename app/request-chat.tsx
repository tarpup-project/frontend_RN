          ...
          <View style={styles.aiMessageWrapper}>
            ...
            >
              ...
              <Text style={[styles.aiMessageText, dynamicStyles.text]}>
                <Text style={styles.boldText}>Great!</Text> Your request has
                been shared with the student. You will be notified when they
                accept, and you'll be automatically added to a group chat
                together. TarpAI will continue working in the background to find
                more compatible matches for you!
              </Text>
            </View>
